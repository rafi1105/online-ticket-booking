    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <div className="w-14 h-14 rounded-xl bg-green-100 dark:bg-green-900/30 flex items-center justify-center">
              <FaTicketAlt className="text-2xl text-green-600 dark:text-green-400" />
            </div>
          </div>
          <p className="text-sm text-gray-500 dark:text-gray-400">Total Tickets Sold</p>
          <p className="text-2xl font-bold text-gray-800 dark:text-white">{stats.totalTicketsSold.toLocaleString()}</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
          ...
          <p className="text-2xl font-bold text-gray-800 dark:text-white">{stats.totalTicketsAdded}</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
          ...
          <p className="text-2xl font-bold text-gray-800 dark:text-white">{stats.totalBookings.toLocaleString()}</p>
        </div>

        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <div className="w-14 h-14 rounded-xl bg-cyan-100 dark:bg-cyan-900/30 flex items-center justify-center">
              <FaCalendarAlt className="text-2xl text-cyan-600 dark:text-cyan-400" />
            </div>
          </div>
          <p className="text-sm text-gray-500 dark:text-gray-400">This Month</p>
          <p className="text-2xl font-bold text-gray-800 dark:text-white">৳{stats.thisMonth.toLocaleString()}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
          <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-6">Revenue by Type</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Top Routes */}
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
          <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-6">Top Routes</h3>
            ...
            {topRoutes.map((route, idx) => (
              <div key={idx} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800 dark:text-white">{route.route}</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">{route.bookings} bookings</p>
                  </div>
                </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
          ...
          <div className="space-y-4">
            {recentTransactions.map((txn) => (
              <div key={txn.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-xl">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white font-bold">
                    {txn.user.charAt(0)}
                  </div>
                  <div>
                    <p className="font-semibold text-gray-800 dark:text-white">{txn.user}</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">{txn.ticket}</p>
                  </div>
                </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg mt-6">
        <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-6">Monthly Bookings</h3>
        <ResponsiveContainer width="100%" height={300}>
